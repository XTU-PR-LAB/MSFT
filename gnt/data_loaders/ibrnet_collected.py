...
class IBRNetCollectedDataset(Dataset):
    def __init__(self, args, mode, random_crop=True, **kwargs):
        self.folder_path1 = os.path.join(args.rootdir, "/home/ubuntu/n417/sisi/GNT-main2/data/ibrnet_collected_1/")
        self.folder_path2 = os.path.join(args.rootdir, "/home/ubuntu/n417/sisi/GNT-main2/data/ibrnet_collected_2/")
