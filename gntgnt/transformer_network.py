...
class GNT(nn.Module):
    def __init__(self, args, N_samples, in_feat_ch=32, posenc_dim=3, viewenc_dim=3, ret_alpha=False):
        ...
        '''self.InvRes = Conv2d_BN(in_features=args.N_samples, out_features=args.N_samples)'''
        self.DeformConv = DeformConv2d(inc=N_samples, outc=N_samples)
        ...
        self.conv2=nn.Conv2d(args.netwidth*2, args.netwidth, kernel_size=1)
        self.conv3=nn.Conv2d(args.netwidth*3, args.netwidth, kernel_size=1)
